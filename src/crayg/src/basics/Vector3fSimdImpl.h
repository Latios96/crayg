...
#ifndef CRAYG_SRC_CRAYG_SRC_BASICS_VEC3_H_
#define CRAYG_SRC_CRAYG_SRC_BASICS_VEC3_H_
...
#endif
{
 public:
    ...
    inline float scalarProduct(const Vector3fSimdImpl &b) const { return _mm_cvtss_f32(_mm_dp_ps(mmvalue, b.mmvalue, 0x71)); }
...
#endif //CRAYG_SRC_CRAYG_SRC_BASICS_VEC3_H_
