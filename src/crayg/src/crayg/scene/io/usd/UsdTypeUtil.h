...
#include "crayg/renderer/integrators/IntegratorType.h"
#include "crayg/renderer/intersectors/IntersectorType.h"
#include "crayg/renderer/tilesamplers/TileSamplerType.h"
#include "crayg/scene/camera/CameraType.h"
