...
#include "crayg/scene/io/read/usd/shadingnetworks/shadingnodes/UsdCheckerBoardReader.h"
#include "crayg/scene/io/read/usd/shadingnetworks/shadingnodes/UsdConstantShadingNodeReaders.h"
#include "crayg/scene/io/read/usd/shadingnetworks/shadingnodes/UsdConversionNodesReaders.h"
#include "crayg/scene/io/read/usd/shadingnetworks/shadingnodes/UsdFileTextureReader.h"
#include "crayg/scene/io/read/usd/shadingnetworks/shadingnodes/UsdPrimVarReaderReaders.h"
...
std::shared_ptr<ShadingNode> insertAutomaticConversion(std::shared_ptr<ShadingNode> &cachedConnectedShader,
    ...
    CRAYG_LOG_AND_THROW_RUNTIME_ERROR(
        "Error when connecting {}.{}. Output type {} can not be connected to input type {} "
