...
template<>\
struct fmt::formatter<crayg::Name> {\
...
\
    ...
    auto format(crayg::Name const &dto, FormatContext &ctx) {\
...
struct Name {\
    ...
    Name() = default;                                                      \
                                                                           \
    Name(FirstType FirstName,SecondType SecondName,ThirdType ThirdName):FirstName(FirstName),SecondName(SecondName),ThirdName(ThirdName){} \
                                                                           \
