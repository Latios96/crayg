...
MINITRACE_EXPORT void internal_mtr_raw_event_arg(const char *category, const char *name, char ph, void *id,
                                                 mtr_arg_type arg_type, const char *arg_name, void *arg_value);
...
#define MTR_INSTANT_C(c, n, aname, astrval)                                                                            \
    internal_mtr_raw_event_arg(c, n, 'I', 0, MTR_ARG_TYPE_STRING_CONST, aname, (void *)(astrval))
#define MTR_INSTANT_I(c, n, aname, aintval)                                                                            \
    internal_mtr_raw_event_arg(c, n, 'I', 0, MTR_ARG_TYPE_INT, aname, (void *)(aintval))
...
#define MTR_META_PROCESS_NAME(n)                                                                                       \
    internal_mtr_raw_event_arg("", "process_name", 'M', 0, MTR_ARG_TYPE_STRING_COPY, "name", (void *)(n))
#define MTR_META_THREAD_NAME(n)                                                                                        \
    internal_mtr_raw_event_arg("", "thread_name", 'M', 0, MTR_ARG_TYPE_STRING_COPY, "name", (void *)(n))
#define MTR_META_THREAD_SORT_INDEX(i)                                                                                  \
    internal_mtr_raw_event_arg("", "thread_sort_index", 'M', 0, MTR_ARG_TYPE_INT, "sort_index", (void *)(i))
...
class MTRScopedTraceArg {
  public:
    MTRScopedTraceArg(const char *category, const char *name, mtr_arg_type arg_type, const char *arg_name,
                      void *arg_value)
