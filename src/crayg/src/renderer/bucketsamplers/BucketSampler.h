#ifndef CRAYG_SRC_CRAYG_SRC_RENDERER_BUCKETSAMPLERS_BUCKETSAMPLER_H_
#define CRAYG_SRC_CRAYG_SRC_RENDERER_BUCKETSAMPLERS_BUCKETSAMPLER_H_
...
#endif // CRAYG_SRC_CRAYG_SRC_RENDERER_BUCKETSAMPLERS_BUCKETSAMPLER_H_
