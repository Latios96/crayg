...
class UsdSphereTranslator : public BaseUsdXformableTranslator<pxr::UsdGeomSphere, Sphere> {
 public:
    UsdSphereTranslator(const pxr::UsdGeomSphere &usdPrim) : BaseUsdXformableTranslator(usdPrim) {
