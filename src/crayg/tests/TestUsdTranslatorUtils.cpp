...
#include "sceneIO/read/usd/UsdTranslatorUtils.h"
...
TEST_CASE("UsdTranslatorUtils::translateTransform") {
    ...
    SECTION("should correctly convert transform prim which has only local transformations") {
        ...
        UsdTranslatorUtils::translateTransform(transformable, usdCamera);
