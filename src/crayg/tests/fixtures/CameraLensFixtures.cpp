...
CameraLens CameraLensFixtures::createSchneider30mmAnamorphic() {
    // US Patent 6310731B1
    std::vector<LensElement> elements = {
        {-101.3, 4, 1.591, 60, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), CYLINDER_Y},
        {50, 7.7, 1.762, 60, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), CYLINDER_Y},
        {87.3, 71.3, 1, 60, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), CYLINDER_Y},
        {999999, 4.4, 1.711, 56, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {122.4, 9.5, 1.716, 56, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), CYLINDER_Y},
        {-122.4, 2, 1, 56, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), CYLINDER_Y},
        {38.4, 6, 1.681, 36, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {-783.3, 0.1, 1, 36, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {35.9, 3.8, 1.758, 32, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {55.5, 2.2, 1, 32, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {-575.3, 9.2, 1.624, 28, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        ...
        {-18.5, 1.5, 1.704, 21, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {70.7, 1.7, 1, 22, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {99.6, 4.4, 1.792, 24, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {-26, 0.3, 1, 24, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
        {115.2, 3.9, 1.732, 28, 0, LensMaterial::createMaterialById(LensMaterialId::UNKNOWN), SPHERICAL},
