...
TEST_CASE("Preconditions:: check unit vector",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_IS_NORMALIZED_VECTOR(Vector3f(1, 2, 3).normalize());
}
...
TEST_CASE("Preconditions:: check array index",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_IS_VALID_INDEX(0, 1);
...
TEST_CASE("Preconditions:: check nullptr", "[Preconditions]"){
    ...
    SECTION("should pass"){const auto ptr = std::make_unique<int>();
...
TEST_CASE("Preconditions:: equals", "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_EQUALS(1, 1);
}
...
TEST_CASE("Preconditions:: not equals", "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_NOT_EQUALS(1, 2);
}
...
TEST_CASE("Preconditions:: greater or equals",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_GREATER_OR_EQUALS(1, 1);
...
TEST_CASE("Preconditions:: greater than", "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_GREATER_THAN(2, 1);
}
...
TEST_CASE("Preconditions:: less or equals", "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_LESS_OR_EQUALS(1, 1);
...
TEST_CASE("Preconditions:: less than", "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_LESS_THAN(1, 2);
}
...
TEST_CASE("Preconditions:: within range inclusive",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_WITHIN_RANGE_INCLUSIVE(1, 1, 3);
...
TEST_CASE("Preconditions:: not within range inclusive",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_NOT_WITHIN_RANGE_INCLUSIVE(0, 1, 3);
...
TEST_CASE("Preconditions:: within range exclusive",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_WITHIN_RANGE_EXCLUSIVE(2, 1, 3);
}
...
TEST_CASE("Preconditions:: not within range exclusive",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_NOT_WITHIN_RANGE_EXCLUSIVE(0, 1, 3);
...
TEST_CASE("Preconditions:: has no NaN",
          "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_HAS_NO_NAN(Vector3f(1, 2, 3));
...
TEST_CASE("Preconditions:: check state", "[Preconditions]"){SECTION("should pass"){CRAYG_CHECK_STATE(1, 1);
}
